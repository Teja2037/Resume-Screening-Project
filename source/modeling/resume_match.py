...
similarity_scores = cosine_similarity(job_vector, resume_embeddings)[0]
resume_df["Match Score"] = similarity_scores
ranked_resumes = resume_df.sort_values(by="Match Score", ascending=False)
print(ranked_resumes[["Resume_ID", "Job Role", "Match Score"]].head(10))
